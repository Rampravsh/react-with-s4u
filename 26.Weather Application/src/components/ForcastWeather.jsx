    ...
    <div className="mt-8 w-full max-w-4xl">
      ...
      <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
        {dailyForecast.map((item, index) => (
          <div key={index} className="card bg-base-100 shadow-md p-4 flex flex-col items-center">
            ...
            <p className="text-xs capitalize opacity-70">{item.weather[0].description}</p>
          </div>
        ))}
      </div>
    </div>
